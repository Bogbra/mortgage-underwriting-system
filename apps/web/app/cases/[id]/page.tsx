    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <AnalysisCard title="Credit Analyst" analysis={caseDetail.credit_analysis} />
          <AnalysisCard title="Income Analyst" analysis={caseDetail.income_analysis} />
          <AnalysisCard title="Asset Analyst" analysis={caseDetail.asset_analysis} />
          <AnalysisCard title="Collateral Analyst" analysis={caseDetail.collateral_analysis} />
        </div>
      </div>
